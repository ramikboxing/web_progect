...
$('.LP').on('click', function(e) {  /*Один клик и заменяем классы*/
		...
		$('.Declarative_languages').toggleClass('Declarative_languages_active'); //заменяем класс Declarative_languages на Declarative_languages_active
		$('.Imperative_languages').toggleClass('Imperative_languages_active'); //заменяем класс Imperative_languages на Imperative_languages_active*/
});
	
	/*Клик кнопки "Декларативные"*/
$('.Declarative_languages').on('click', function(e) {  /*Один клик и заменяем классы*/
	lpd++;
		e.preventDefault; // отменяет стандартное событие
		/*Выводим кнопки*/
...
$('.Imperative_languages').on('click', function(e) {  /*Один клик и заменяем классы*/
	lpi++;	
		e.preventDefault; // отменяет стандартное событие
